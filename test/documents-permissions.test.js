...
test("players can manipulate cards and fully manage board connections", () => {
  ...
  assert.equal(canModifyBoard(player, "duplicateCard"), false);
  assert.equal(canModifyBoard(player, "createConnection"), true);
